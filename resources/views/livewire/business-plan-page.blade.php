        ...
        <div class="container">
            <div class="row align-items-center inner-banner">
                <div class="col-md-12 col-12 text-center">
                    <h2 class="breadcrumb-title">Business Plan</h2>
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item" aria-current="page">Business Plan</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="section-inner-header about-inner-header">
                        ...
                        <h2>Dream. Innovate. Implement.</h2>
                    </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-img-info">
                        <img src="web_assets/assets/img/business-plan.png" alt="" class="w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="book-appointment-section aos" data-aos="fade-up">
        <div class="container">
            <div class="book-appointment-ten text-center">
                ...
                <p>It appears you don't have a PDF plugin for this browser. <br>No biggie... you can</p>
                <div class="appointment-btn-group">
                    <a href="#" class="appointment-blue-btn">Click here to download the PDF</a>
                </div>
            </div>
        </div>
    </section>
