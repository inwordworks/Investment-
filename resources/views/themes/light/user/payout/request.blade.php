...
<div class="container-fluid">
    <div class="main row">
        @if(auth()->user()->total_invest == null || auth()->user()->total_invest == 0 || auth()->user()->total_invest == '')
        <div class="media align-items-center d-flex justify-content-between alert alert-danger mb-4">
            <div class="fs-5">
                <i class="fas fa-exclamation-triangle me-2"></i>
                To request a withdrawal, please ensure you have an active investment in one of our available projects or plans. Invest now to unlock withdrawal options.
            </div>
        </div>
        @endif
        <div class="col-12">
