                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        value="{{ old('title') }}" name="title" id="projectTitle"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror"
                                        value="{{ old('location') }}" id="project_location" name="location"
                                        placeholder="e.g : ironclad city">
                                    @error('location')
                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <i class="bi bi-info-circle text-body ms-1" data-bs-toggle="tooltip"
                                    ...
                                    data-bs-original-title="The total duration of the project, from start to end."></i>
                                <div class="input-group mb-4">
                                    <input type="number" name="project_duration" value="{{ old('project_duration') }}"
                                        id="project_duration"
                                        class="form-control @error('project_cycle') is-invalid @enderror"
                                        placeholder="e.g : 5 years" step="0.1">
                                    <!-- Select -->
                                    <div class="tom-select-custom">
                                        <select class="js-select form-select" name="project_duration_type"
                                            id="project_duration_type" autocomplete="off"
                                            data-hs-tom-select-options='{
                                                  "hideSearch": true
                                             }'>
                                            <option value="Month" @selected(old('project_duration_type')=='Month' )>@lang('Month')
                                            </option>
                                            <option value="Year" @selected(old('project_duration_type')=='Year' )>@lang('Year')
                                            </option>
                                            <option value="Day" @selected(old('project_duration_type')=='Day' )>@lang('Day')
                                            </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    <!-- Flatpickr -->
                                    <input type="text" class="js-flatpickr form-control flatpickr-custom"
                                        id="start_date" name="invest_last_date"
                                        value="{{ old('invest_last_date') }}" placeholder="Select dates"
                                        data-hs-flatpickr-options='{
                                             "dateFormat": "Y/m/d"
                                           }'>
                                    <!-- End Flatpickr -->
                            ...
                            <div class="col-md-6" id="minimum_invest_field">
                                ...
                                <div class="input-group mb-4">
                                    <input type="number"
                                        ...
                                        value="{{ old('minimum_invest') }}" id="minimum_invest"
                                        name="minimum_invest" placeholder="e.g : 15000" step="0.01">
                            ...
                            <div class="col-md-6" id="maximum_invest_field">
                                ...
                                <div class="input-group mb-4">
                                    <input type="number"
                                        ...
                                        value="{{ old('maximum_invest') }}" id="minimum_invest"
                                        name="maximum_invest" placeholder="e.g : 20000"
                                        step="0.01
                                        ">
                                    <span class="input-group-text"
                                        id="priceCurrency">{{ basicControl()->currency_symbol }}</span>
                            ...
                            <div class="col-md-6" id="fixed_invest_amount">
                                ...
                                <div class="input-group mb-4">
                                    <input type="number"
                                        class="form-control @error('invest_amount') is-invalid @enderror"
                                        value="{{ old('invest_amount') }}" id="invest_amount" name="invest_amount"
                                        placeholder="e.g : 25000" step="0.01">
                                    <span class="input-group-text"
                                        id="priceCurrency">{{ basicControl()->currency_symbol }}</span>
                                    @error('invest_amount')
                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    <input type="number"
                                        ...
                                        value="{{ old('total_units') }}" id="TotalUnit" name="total_units"
                                        placeholder="e.g : 500">
                                    @error('total_units')
                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="col-12">
                            <label class="form-check form-check-dashed" for="logoUploader" id="content_img">
                                <img id="contentImg" class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                                    ...
                                    alt="Image Description" data-hs-theme-appearance="default">
                                <img id="contentImg" class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                                    src="{{ asset('assets/admin/img/oc-browse-file.svg') }}" alt="Image Description"
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-sm-auto d-flex align-items-center">
                                                    <div class="form-check form-switch form-switch-google">
                                                        <input type="hidden" name="project_duration_has_unlimited"
                                                            value="0">
                                                        <input class="form-check-input"
                                                            name="project_duration_has_unlimited" type="checkbox"
                                                            id="project_duration_is_fixed" value="1"
                                                            @checked(old('project_duration_has_unlimited')==1)>
                                                        <label class="form-check-label"
