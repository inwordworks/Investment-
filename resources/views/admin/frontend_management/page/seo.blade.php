                            ...
                            <form action="{{ route('admin.page.seo.update', $pageSEO->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mb-4">
                                        ...
                                        <textarea id="metaDescription" class="form-control" name="meta_description" placeholder="@lang("Meta Description")" rows="5">{{ old("meta_description", $pageSEO->meta_description) }}</textarea>
