                                                    ...
                                                    @if($type == "text")
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input type="@lang($type)" id="@lang($name)"
                                                                   ...
                                                                   value="{{ old(@$name.'.'.$language->id, isset($multipleContentData[$language->id]) ? @$multipleContentData[$language->id][0]->description->{$name}??@$multipleContentData[$language->id][0]->content->media->{$name} : '') }}"
