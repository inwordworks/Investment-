<!-- Navbar Vertical -->
<aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-vertical-aside-initialized
                ...
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle {{ menuActive(['admin.ticket', 'admin.ticket.search', 'admin.ticket.view'], 3) }}"
                            href="#navbarVerticalAttributesMenu" role="button" data-bs-toggle="collapse"
                            data-bs-target="#navbarVerticalAttributesMenu" aria-expanded="false"
                        ...
                        <div id="navbarVerticalAttributesMenu"
                            ...
                            <a class="nav-link <?= request()->is('admin/ecommerce/attributes/' . $attributes->slug) ? 'active' : '' ?>"
                                href="<?= route('admin.ecommerce.attributes.single_attribute', $attributes->slug) ?>">
                                <?= $attributes->name ?>
                            </a>
                            <?php } ?>
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle {{ menuActive(['admin.ticket', 'admin.ticket.search', 'admin.ticket.view'], 3) }}"
                            href="#navbarVerticalTicketMenu" role="button" data-bs-toggle="collapse"
                            data-bs-target="#navbarVerticalTicketMenu" aria-expanded="false"
                    ...
                    <div class="nav-item" {{ menuActive(['admin.kyc.list*', 'admin.kyc.view'], 3) }}>
                        <a class="nav-link dropdown-toggle collapsed" href="#navbarVerticalKycRequestMenu" role="button"
                            data-bs-toggle="collapse" data-bs-target="#navbarVerticalKycRequestMenu"
                            aria-expanded="false" aria-controls="navbarVerticalKycRequestMenu">
                            <i class="bi bi-person-lines-fill nav-icon"></i>
                            <span class="nav-link-title">@lang("KYC Request")</span>
                            @if ($pendingKyc = App\Models\UserKyc::where('status', '0')->count() > 0)
                                <small
                                style="min-width:20px; height:20px;"
                                    class="badge rounded-pill bg-danger rounded-circle ms-2">{{ $pendingKyc > 9 ? '9+' : $pendingKyc }}</small>
                            @endif
                        </a>
                    ...
                    <div class="nav-item">
                        ...
                        <div id="navbarVerticalUserPanelMenu" class="nav-collapse collapse {{ menuActive([
    'admin.mail.all.user',
    'admin.users',
    'admin.users.add',
    'admin.user.edit',
    ...
    'admin.user.kyc.list',
    'admin.send.email'
], 2) }}" data-bs-parent="#navbarVerticalUserPanelMenu">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ menuActive(['admin.investors']) }}" href="{{ route('admin.investors') }}"
                            data-placement="left">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ menuActive(controlPanelRoutes()) }}" href="{{ route('admin.settings') }}"
                            data-placement="left">
                    ...
                    <div
                        ...
                        <a class="nav-link dropdown-toggle" href="#navbarVerticalGatewayMenu" role="button"
                            data-bs-toggle="collapse" data-bs-target="#navbarVerticalGatewayMenu" aria-expanded="false"
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle {{ menuActive(['admin.payout.method.list', 'admin.payout.method.create', 'admin.manual.method.edit', 'admin.payout.method.edit', 'admin.payout.withdraw.days'], 3) }}"
                            href="#navbarVerticalWithdrawMenu" role="button" data-bs-toggle="collapse"
                            data-bs-target="#navbarVerticalWithdrawMenu" aria-expanded="false"
                    ...
                    <div id="navbarVerticalThemeMenu" class="d-none">
                        ...
                        <div class="nav-item">
                            <a class="nav-link {{ menuActive(['admin.navbar.style']) }}"
                                href="{{ route('admin.navbar.style', basicControl()->theme) }}" data-placement="left">
                        ...
                        <div class="nav-item">
                            <a class="nav-link {{ menuActive(['admin.page.index', 'admin.create.page', 'admin.edit.page', 'admin.edit.static.page', 'admin.page.seo']) }}"
                                href="{{ route('admin.page.index', basicControl()->theme) }}" data-placement="left">
                                <i class="fa-light fa-list nav-icon"></i>
                    ...
                    <div class="nav-item d-none">
                        <a class="nav-link dropdown-toggle {{ menuActive(['admin.manage.content', 'admin.manage.content.multiple', 'admin.content.item.edit*'], 3) }}"
                            href="#navbarVerticalContentsMenu" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="nav-item d-none">
                        <a class="nav-link dropdown-toggle {{ menuActive(['admin.blog-category.index', 'admin.blog-category.create', 'admin.blog-category.edit', 'admin.blog.seo', 'admin.blogs.index', 'admin.blogs.create', 'admin.blogs.edit'], 3) }}"
                            href="#navbarVerticalBlogMenu" role="button" data-bs-toggle="collapse"
