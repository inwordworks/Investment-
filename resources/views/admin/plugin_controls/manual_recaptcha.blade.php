                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="form-check form-switch">
                                                            <input type="hidden" name="recaptcha_admin_login" value="0">
                                                            <input class="form-check-input" name="recaptcha_admin_login" type="checkbox" id="adminLoginRecaptcha" value="1"
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="form-check form-switch">
                                                            <input type="hidden" name="reCaptcha_status_login" value="0">
                                                            <input class="form-check-input" name="reCaptcha_status_login" type="checkbox" id="userLoginRecaptcha" value="1"
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="form-check form-switch">
                                                            <input type="hidden" name="reCaptcha_status_registration" value="0">
                                                            <input class="form-check-input" type="checkbox" name="reCaptcha_status_registration" id="userRegistrationRecaptcha" value="1"
