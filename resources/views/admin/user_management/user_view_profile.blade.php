                        ...
                        <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled list-py-2 text-dark mb-0">
                                    ...
                                    <li><i class="bi bi-wallet dropdown-item-icon"></i> {{ currencyPosition($user->balance) }} (Balance)
                                    <li><i class="bi bi-wallet dropdown-item-icon"></i> {{ currencyPosition($user->profit_balance) }} (Profit Balance)
                                    </li>
