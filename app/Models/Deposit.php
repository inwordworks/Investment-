...
class Deposit extends Model
{
    ...
    public function getStatus(): string
    {
        switch ($this->status) {
            ...
            case 1:
                return '<span class="badge text-bg-success">' . trans('Success') . '</span>';
            case 2:
                return '<span class="badge text-bg-info">' . trans('Request') . '</span>';
            case 3:
                return '<span class="badge text-bg-danger">' . trans('Rejected') . '</span>';
            default:
    ...
    {
        return static::where('created_at', '<=', now()->subDays(3))->where('status', 0);
    }
