...
$('body').append('<div class="sidebar-overlay"></div>');$(document).on('click','#mobile_btn',function(){$('main-wrapper').toggleClass('slide-nav');$('.sidebar-overlay').toggleClass('opened');$('html').toggleClass('menu-opened');return false;});$(document).on('click','.sidebar-overlay',function(){$('html').removeClass('menu-opened');$(this).removeClass('opened');$('main-wrapper').removeClass('slide-nav');});$(document).on('click','#menu_close',function(){$('html').removeClass('menu-opened');$('.sidebar-overlay').removeClass('opened');$('main-wrapper').removeClass('slide-nav');});if($('[data-bs-toggle="tooltip"]').length>0){var tooltipTriggerList=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
var tooltipList=tooltipTriggerList.map(function(tooltipTriggerEl){return new bootstrap.Tooltip(tooltipTriggerEl)})}
$(".hours-info").on('click','.trash',function(){$(this).closest('.hours-cont').remove();return false;});$(".add-hours").on('click',function(){var hourscontent='<div class="row hours-cont">'+
...
if($('.header-trans.header-eight').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-trans").css("background","#ffffff");}
else{$(".header-trans").css("background","transparent");}})})}
if($('.header-trans.header-two').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-trans").css("background","#ffffff");}
else{$(".header-trans").css("background","transparent");}})})}
if($('.header-trans.custom').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-trans").css("background","#2b6ccb");}
else{$(".header-trans").css("background","transparent");}})})}
if($('.header-one').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>35){$(".header-one").addClass('header-space');}
else{$(".header-one").removeClass('header-space');}})})}
if($('.header-ten').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>35){$(".header-ten").addClass('header-space');}
else{$(".header-ten").removeClass('header-space');}})})}
if($('.header-fourteen').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-fourteen").css("background","#2b6ccb");}
else{$(".header-fourteen").css("background","transparent");}})})}
if($('.header-fourteen.header-twelve').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-fourteen").css("background","#fff");}
else{$(".header-fourteen").css("background","transparent");}})})}
if($('.header-fifteen').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-trans").css("background","#FFFFFF");}
else{$(".header-trans").css("background","transparent");}})})}
if($('.header-trans.custom').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-trans").css("background","#2b6ccb");}
else{$(".header-trans").css("background","transparent");}})})}
if($('.header-trans.header-eleven').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-trans").css("background","#1e5d92");}
else{$(".header-trans").css("background","transparent");}})})}
if($('.header-one').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>35){$(".header-one").addClass('header-space');}
else{$(".header-one").removeClass('header-space');}})})}
if($('.header-fourteen').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-fourteen").css("background","#2b6ccb");}
else{$(".header-fourteen").css("background","transparent");}})})}
if($('.header-fifteen').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-fifteen").css("background","#ffffff");}
else{$(".header-fifteen").css("background","transparent");}})})}
if($('.header-sixteen').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-sixteen").css("background","#ffffff");}
else{$(".header-sixteen").css("background","transparent");}})})}
if($('.header-fourteen.header-twelve').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-fourteen").css("background","#fff");}
else{$(".header-fourteen").css("background","transparent");}})})}
if($('.header-fourteen.header-thirteen').length>0){$(document).ready(function(){$(window).scroll(function(){var scroll=$(window).scrollTop();if(scroll>95){$(".header-fourteen").css("background","#fff");}
...
$('.slider-service').css('padding-left',right_position_value);});if($('#bmi-status').length>0){var options={series:[{name:"BMI",data:[10,41,35,51,49,62,69,91,148]}],chart:{height:350,type:'line',zoom:{enabled:false}},dataLabels:{enabled:false},stroke:{curve:'straight'},title:{align:'left'},grid:{row:{colors:['#f3f3f3','transparent'],opacity:0.5},},xaxis:{categories:['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'],}};var chart=new ApexCharts(document.querySelector("#bmi-status"),options);chart.render();}
...
$(document).ready(function(){$(".searchbar a").click(function(){$(".togglesearch").slideToggle();$(".top-search").focus();});});if($('#more-view2').length>0){const button=document.getElementById('more-view2');const container=document.getElementById('fill-more2');let isLess=true;function showMoreLess(){if(isLess){isLess=false;container.style.height='auto';button.innerHTML="Show less <i class='feather-chevrons-right ms-1'>";}else{isLess=true;container.style.height='100px';button.innerHTML="Show more <i class='feather-chevrons-right ms-1'></i>";}}
button.addEventListener('click',showMoreLess);}
if($('#more-view').length>0){const button=document.getElementById('more-view');const container=document.getElementById('fill-more');let isLess=true;function showMoreLess(){if(isLess){isLess=false;container.style.height='auto';button.innerHTML="Show less <i class='feather-chevrons-right ms-1'>";}else{isLess=true;container.style.height='100px';button.innerHTML="Show more <i class='feather-chevrons-right ms-1'></i>";}}
button.addEventListener('click',showMoreLess);}
if($('#more-view1').length>0){const button=document.getElementById('more-view1');const container=document.getElementById('fill-more1');let isLess=true;function showMoreLess(){if(isLess){isLess=false;container.style.height='auto';button.innerHTML="Show less <i class='feather-chevrons-right ms-1'>";}else{isLess=true;container.style.height='100px';button.innerHTML="Show more <i class='feather-chevrons-right ms-1'></i>";}}
button.addEventListener('click',showMoreLess);}
...
"</td>"+
"</tr>";$(".add-table-items").append(itemscontent);return false;});$(".add-table-prescription").on('click','.trash',function(){$(this).closest('.test').remove();return false;});$(".add-prescription").on('click',function(){var itemscontent='<tr class="test">'+
'<td>'+
...
'</td>'+
'</tr>';$(".add-table-prescription").append(itemscontent);return false;});})(jQuery);